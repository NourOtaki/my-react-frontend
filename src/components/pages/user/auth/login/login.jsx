...
// //       {/* صور الخلفية تظهر فقط من md وفوق */}
// //       <img
// //         src={img2}
...
// //       <img
// //         src={img1}
// //         className="absolute top-[75%] left-[80%] hidden h-20 md:block md:h-28"
// //       />
...
// //       >
// //         {/* الخلفية المائلة مخفية بالموبايل */}
...
// //         <div className="relative flex  w-full h-[360px] flex-col justify-center md:flex-row md:gap-6">
// //           {/* الفورم */}
// //           <div className="w-full relative top-10 md:w-1/2">
...
// //           {/* النص الجانبي يظهر فقط من 768px وفوق */}
// //           <div className="hidden w-full px-2 relative top-14 left-10 text-white md:block md:w-1/2">
...
//           {/* الفورم */}
//           <div className="relative top-10 w-full md:w-1/2">
//             <h2 className="font-Carter text-textColor mb-4 text-center text-2xl font-semibold md:text-left md:text-[35px]">
//               Login
//             </h2>
//             <Formik
...
//                   // ✅ حفظ التوكن وبيانات المستخدم بشكل صحيح
//                   localStorage.setItem("TOKEN", response.Token);
//                   localStorage.setItem(
//                     "user",
//                     JSON.stringify({
