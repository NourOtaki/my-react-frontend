...
//         );
//         setError("Failed to fetch last reservation");
//       } finally {
//         setLoading(false);
//       }
//     };
...
//       alert("Error occurred while canceling the reservation.");
//     }
//   };
...
//         You have no reservations. Please make one first.
//       </p>
//     );
...
//         </p>
//         <p>
//           <span className="font-semibold">User ID:</span> {reservation.user_id}
//         </p> */}
//         <p>
...
//           <span
//             className={`font-bold ${reservation.status === "confirmed" ? "text-green-600" : "text-red-500"}`}
//           >
