...
// //         console.log("f",fav)
// //         setFav(response.data.data); // بناءً على شكل الاستجابة من Laravel
// //       } catch (err) {
...
// //   const deleteFavorites = async (mealType) => {

// //     try {
// //       const token = localStorage.getItem("token");

// //       const response = await axios.delete(
// //         `http://127.0.0.1:8000/api/deletefavorites/${mealType}`,
// //         {
// //           headers: {
...
// //   console.log("fav", fav);
// //   return (
// //     <div className="background relative min-h-screen  grid gap-y-14 px-[20%] py-8 md:grid-cols-2 md:gap-x-20 md:px-16 lg:px-26 xl:grid-cols-3 xl:gap-x-26">
// //       {fav.map((item, index) => (
// //         <div
// //           key={index}
// //           className="m-10 size-56 overflow-hidden rounded-2xl transition duration-[.4s]"
// //         >
// //           <div className="peer hover:opacity-45">
// //             <img
// //               className="size-56"
// //               src={`http://127.0.0.1:8000/storage/${fav[index].meal.image}`}
// //               alt="meal"
// //             />
// //           </div>
// //           <div className="relative -top-26 hidden text-center peer-hover:block">
// //             <div className="font-Carter relative mb-3 text-2xl font-bold">
// //               {fav[index].meal.type}
// //             </div>
// //             <Link
// //               className="relative"
...
// //             </Link>
// //             <div className="relative -top-48 left-22">
// //               <i
// //                 onClick={() => deleteFavorites(item.id)}
// //                 class="ri-heart-3-fill text-firstColor text-2xl"
// //               ></i>
// //             </div>
// //           </div>
// //         </div>
...
//       // بعد الحذف حدث الـ state بدل ما تعمل reload
