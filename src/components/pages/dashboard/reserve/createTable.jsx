...
//       alert("تم توفير طاولة!");
//       console.log(response.data);
//       resetForm();
//       window.location.reload();
//     } catch (error) {
//       console.error("فشل توفير طاولة:", error);
//       alert("حدث خطأ أثناء توفير طاولة.");
//     }
//   };
...
//               )
//               .typeError("السعة يجب أن تكون رقم صحيح")
//               .required("يرجى تحديد السعة")
...
//                   : Number(originalValue),
//               )
//               .typeError("السعر يجب أن يكون رقم صحيح")
//               .required("يرجى تحديد السعر")
//               .min(1, "السعر يجب أن يكون 1 على الأقل"),
//           })}
...
//                   value={values.price}
//                   onChange={(e) =>
//                     setFieldValue("price", Math.max(1, Number(e.target.value)))
//                   }
//                 />
//                 <ErrorMessage
//                   name="price"
