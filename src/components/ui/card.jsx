...
const Card = () => {
  return (
    <StyledWrapper >
      <div className="card left-12 relative">
        <ul>
          <li className="iso-pro">
            ...
            <div className="text relative left-8 -rotate-90">Facebook</div>
          </li>
          <li className="iso-pro">
            <span />
            <span />
            ...
            <div className="text relative left-11 -rotate-90">Twitter</div>
          </li>
          <li className="iso-pro">
            <span />
            <span />
            ...
            <div className="text relative left-7.5 -rotate-90">Instagram</div>
          </li>
        </ul>
      </div>
    </StyledWrapper>
